 ...
 */
public interface IShimTextCellProcessor {
    
    /**
     * This function typically processes only one array cell
     * @param cell String representation of a complete cell including attributes. This must be splitted to attributes manually.
     */
